...
If you are unfamiliar with data preprocessing, first review **NumPy & Pandas** section of ```Python for data analysis``` repository materials(https://github.com/buomsoo-kim/Python-for-data-analysis)
